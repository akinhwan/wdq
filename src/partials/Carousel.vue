    ...
    <div class="py-12 md:py-20">
      ...
      <div class="carousel swiper-container">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide max-w-lg">
            <img class="transition-opacity duration-300" :src="require('@/images/carousel-item-02.jpg')" width="540" height="460" alt="Carousel item 02" />
            <div class="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
              <div class="flex flex-grow">
                <a class="inline-flex btn-sm text-white bg-teal-500 hover:bg-teal-400 mx-auto self-center" href="#0">Learn more</a>
              </div>
          ...
          <div class="swiper-slide max-w-lg">
            <img class="transition-opacity duration-300" :src="require('@/images/carousel-item-03.jpg')" width="540" height="460" alt="Carousel item 03" />
            <div class="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
              <div class="flex flex-grow">
                <a class="inline-flex btn-sm text-white bg-teal-500 hover:bg-teal-400 mx-auto self-center" href="#0">Learn more</a>
              </div>
          ...
          <div class="swiper-slide max-w-lg">
            <img class="transition-opacity duration-300" :src="require('@/images/carousel-item-04.jpg')" width="540" height="460" alt="Carousel item 04" />
            <div class="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
              <div class="flex flex-grow">
                <a class="inline-flex btn-sm text-white bg-teal-500 hover:bg-teal-400 mx-auto self-center" href="#0">Learn more</a>
              </div>
          ...
          <div class="swiper-slide max-w-lg">
            <img class="transition-opacity duration-300" :src="require('@/images/carousel-item-05.jpg')" width="540" height="460" alt="Carousel item 05" />
            <div class="absolute inset-0 flex flex-col transition-opacity duration-300 translate-z-0">
              <div class="flex flex-grow">
                <a class="inline-flex btn-sm text-white bg-teal-500 hover:bg-teal-400 mx-auto self-center" href="#0">Learn more</a>
              </div>
