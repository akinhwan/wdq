      ...
      <div class="pt-32 pb-10 md:pt-40 md:pb-16">
        ...
        <div class="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
          ...
          <div class="md:col-span-7 lg:col-span-7 mb-8 md:mb-0 text-center md:text-left">
            ...
            <form data-aos="fade-down" data-aos-delay="300" action="https://app.convertkit.com/forms/1967626/subscriptions"
            class="mt-8 seva-form formkit-form" method="post" data-sv-form="1967626" data-uid="f0509ae312"
            ...
            <div data-style="clean flex flex-col sm:flex-row justify-center max-w-sm mx-auto sm:max-w-md md:mx-0">
              <ul class="formkit-alert formkit-alert-error" data-element="errors" data-group="alert"></ul>
              <div data-element="fields" data-stacked="false" class="seva-fields formkit-fields">
                <div class="formkit-field">
                  <input class="formkit-input form-input w-full mb-2 sm:mb-0 sm:mr-2" name="email_address"
                    ...
                    <button
                  data-element="submit" class="formkit-submit formkit-submit btn text-white bg-teal-500 hover:bg-teal-400 flex-shrink-0"
                  style="color: rgb(255, 255, 255); background-color: rgb(22, 119, 190); border-radius: 4px; font-weight: 400;">
                  <div class="formkit-spinner">
                    <div></div>
                    <div></div>
                    <div></div>
                  </div><span class="bg-teal-500 hover:bg-teal-400 flex-shrink-0">Subscribe</span>
                </button>
              </div>
              <!-- <div class="formkit-powered-by-convertkit-container"><a
                  ...
                  data-element="powered-by" class="formkit-powered-by-convertkit" target="_blank"
