      ...
      <div class="py-12 md:py-20">
        ...
        <div data-aos="fade-up" data-aos-delay="450">
          ...
          <div class="mb-10">
            <div class="flex flex-wrap justify-center -m-1">
              <button
                ...
                @click="category = ''"
              >
                <svg class="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <svg class="w-4 h-4 flex-shrink-0 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <path class="fill-current" :class="category === '1' ? 'text-teal-200 dark:text-teal-400' : 'text-teal-500'" d="M5 16H4a4 4 0 01-4-4v-1h2v1a2 2 0 002 2h1v2zM13 10h-1.586l-1.207-1.207L14.37 4.63a2.121 2.121 0 00-3-3L7.207 5.793 5.99 4.576 5.98 3.02 3.038.079 0 3.117 3 6h1.586l1.207 1.207L4 9l3 3 1.793-1.793L10 11.414V13l3.01 3.01 2.98-2.979L13 10z" />
                </svg>
          ...
          <div class="-mb-2">
            ...
            <!-- 1st Article -->
            <article class="mb-2" v-show="['', '1'].includes(category)">
                  ...
                  <footer class="text-sm flex items-center mt-3">
                    <div class="flex flex-shrink-0 mr-3">
                      <a class="relative" href="#0">
                        ...
                        <img class="relative rounded-full" :src="require('@/images/news-author-01.jpg')" width="32" height="32" alt="Author 01" />
                      </a>
                    </div>
            ...
            <!-- 2nd Article -->
            <article class="mb-2" v-show="['', '2'].includes(category)">
              <div class="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                <!-- Category icon -->
                <div class="flex items-center px-4 sm:px-8">
                  <svg class="w-8 h-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <footer class="text-sm flex items-center mt-3">
                    <div class="flex flex-shrink-0 mr-3">
                      ...
                      <a class="relative -ml-2" href="#0">
                        <span class="absolute inset-0 -m-px" aria-hidden="true"><span class="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                        <img class="relative rounded-full" :src="require('@/images/news-author-02.jpg')" width="32" height="32" alt="Author 02" />
                      </a>
                    </div>
                    <div class="text-gray-500">
                      <span>Written by </span>
            ...
            <!-- 3rd Article -->
            <article class="mb-2" v-show="['', '3'].includes(category)">
              <div class="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                <!-- Category icon -->
                <div class="flex items-center px-4 sm:px-8">
                  <svg class="w-8 h-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pl-6">
                  ...
                  <footer class="text-sm flex items-center mt-3">
                    <div class="flex flex-shrink-0 mr-3">
                      <a class="relative" href="#0">
                        <span class="absolute inset-0 -m-px" aria-hidden="true"><span class="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                        <img class="relative rounded-full" :src="require('@/images/news-author-03.jpg')" width="32" height="32" alt="Author 03" />
                      </a>
                    </div>
                    <div class="text-gray-500">
                      <span>Written by </span>
            ...
            <!-- 4th Article -->
            <article class="mb-2" v-show="['', '4'].includes(category)">
              <div class="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                <!-- Category icon -->
                <div class="flex items-center px-4 sm:px-8">
                  <svg class="w-8 h-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="pl-6">
                  ...
                  <footer class="text-sm flex items-center mt-3">
                    <div class="flex flex-shrink-0 mr-3">
                      <a class="relative" href="#0">
                        <span class="absolute inset-0 -m-px" aria-hidden="true"><span class="absolute inset-0 -m-px bg-white dark:bg-gray-800 rounded-full"></span></span>
                        <img class="relative rounded-full" :src="require('@/images/news-author-05.jpg')" width="32" height="32" alt="Author 05" />
                      </a>
                    </div>
                    <div class="text-gray-500">
                      <span>Written by </span>
          ...
          <nav class="flex justify-center sm:justify-between mt-12">
            <span class="hidden sm:inline-flex items-center font-medium text-gray-400 dark:text-gray-500" href="#0">
              <svg class="w-3 h-3 flex-shrink-0 mt-px mr-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
